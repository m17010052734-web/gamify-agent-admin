...
export default function Credits() {
  ...
  const renderConfigGroup = (title: string, items: CreditConfig[]) => (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="divide-y divide-gray-200">
        {items.map((config) => (
          <div key={config.config_key} className="px-6 py-4 hover:bg-gray-50 transition-smooth">
                ...
                {editingKey === config.config_key ? (
                  <>
                    ...
                    <button
                      ...
                      className="p-2 text-green-600 hover:bg-green-50 rounded-lg transition-smooth cursor-pointer"
                      title="保存"
                    >
                    ...
                    <button
                      onClick={cancelEdit}
                      className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-smooth cursor-pointer"
                      title="取消"
                    >
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="p-2 text-primary hover:bg-blue-50 rounded-lg transition-smooth cursor-pointer"
                      title="编辑"
                    >
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-heading font-bold text-gray-900">积分配置</h1>
